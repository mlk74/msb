    ...
    <div class="container" style="background-color: #495463;">
        ...
        ?>
                    ...
                    <form name="rating" method="post">
                        ...
                        <button class='transparent' type="submit" name="submituserrate"><?php echo $status; ?>
                            Rating</button>
                    </form>
                </div>
                <br>
                ...
                <h6 style='padding: 10px; background-color: #353b43;' class='bg-info text-white'>Add a comment</h6>
                <form name="form" method="post">
                    <div class="form-group">
                        <textarea class="form-control" name="comment" maxlength="200" placeholder="Your Comment Goes Here... (200 Characters Max)
                                " rows="5" required style='background-color: #506075; color:white;'></textarea>
                    </div>
                    <div class="form-group row justify-content-end">
                        <button type="submit" name="submituserreview" class='transparent'>Comment</button>
                    </div>
                </form>
                <hr />
                <!-- Display Comments -->
