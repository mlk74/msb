                        ...
                        <div class="col col-lg-9 col-xl-7">
                            <div class="card">
                                <div class="rounded-top text-white d-flex flex-row"
                                    style="background-color:#AEC69F; height:250px;">
...
//     // $update = "update users set username='$fname',city='$city',picture='$pic' where id='$id'";
//     // $sql2=mysqli_query($conn,$update);


//     $sql3 = "UPDATE users SET city = ?, picture = ?,fname = ? WHERE id=";
//     $stmt = $conn->prepare($sql3);
//     $stmt->bind_param("sssi", $city, $imageData, $fname, $_SESSION["User_ID"]);
//   if ($stmt->execute()) {
